...
<html lang="es">
  ...
  <body>
    ...
    <main class="container py-4">
      ...
      <div
        class="d-flex flex-column flex-md-row justify-content-between align-items-md-center pb-3 mb-4 border-bottom"
      >
        <div>
          <h2 class="fw-bold text-dark mb-1">
            <i class="bi bi-arrow-left-right me-2 text-primary"></i> Control de Préstamos y
            Devoluciones
          </h2>
          <p class="text-muted mb-0">
            Supervisa las solicitudes de los estudiantes y registra las devoluciones físicas al
            inventario.
          </p>
        </div>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <small class="text-muted"
                          ><c:out value="${p.usuario.rut}" /> &bull;
                          <c:out value="${p.usuario.carrera}"
                        /></small>
                      </td>
                      <td>
                      ...
                      <td>
                        <span class="fw-bold text-dark"
                          ><c:out value="${p.fechaDevolucionEsperada}"
                        /></span>
                      </td>
                      <td>
                        <c:choose>
                        ...
                        <c:choose>
                          ...
                          <c:otherwise>
                            <span class="text-muted small"
                              ><i class="bi bi-check-circle text-success me-1"></i> Finalizado</span
                            >
                          </c:otherwise>
                        </c:choose>
                      </td>
        ...
        <div class="modal-content border-0 shadow-lg rounded-4">
          <form action="${pageContext.request.contextPath}/prestamos" method="POST">
            ...
            <div class="modal-body p-4">
              <p class="mb-2">
                Vas a registrar el reintegro de este ejemplar al inventario activo de la biblioteca.
              </p>
              ...
              <div class="mb-3">
                ...
                <input
                  ...
                  class="form-control"
                  value="Ejemplar devuelto en buenas condiciones en mesón de atención"
                />
              </div>
            </div>
